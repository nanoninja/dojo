...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateBundleRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateBundleRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/bundles/{id}/courses": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Course IDs payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SetCoursesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/certificates/verify/{uuid}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Certificate public UUID",
                        "name": "uuid",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateChapterRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/courses": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Filter published courses",
                        "name": "is_published",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/courses/{course_id}/reviews/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SetCategoriesRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.CreateLessonRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.LessonResource"
                        }
                    },
                    "400": {
                        "description": "invalid request body",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateLessonRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.AddResourceRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SaveProgressRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/progress/{user_id}/courses/{course_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/model.LessonProgress"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/progress/{user_id}/lessons/{lesson_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handler.LoginHistoryEntry"
                            }
                        }
                    },
                    "401": {
        ...
        "/api/v1/users/{id}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Required in cookie/dual mode",
                        "name": "X-CSRF-Token",
                        "in": "header"
                    }
                ],
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "2FA required — complete OTP flow",
                        "schema": {
                            "$ref": "#/definitions/handler.OTPRequiredResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ResendRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SendPasswordResetRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/token/refresh": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Cookie mode: tokens are set in HttpOnly cookies",
                        "schema": {
                            "$ref": "#/definitions/handler.RefreshCookieModeResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.VerifyAccountRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/readyz": {
            "get": {
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "not ready to receive traffic",
                        "schema": {
                            "$ref": "#/definitions/handler.ReadyResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "handler.AuthCookieModeResponse": {
            "type": "object",
            "properties": {
                "authenticated": {
                    "type": "boolean",
        ...
        "handler.LoginHistoryEntry": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.LoginStatus"
                },
                "user_agent": {
                    "type": "string"
                }
        ...
        "handler.MeResponse": {
            ...
            "properties": {
                ...
                "vat_number": {
                    "description": "Sensitive — visible only to the owner",
                    "type": "string"
                },
                "website": {
                    "type": "string"
        ...
        "handler.ReadyResponse": {
            ...
            "properties": {
                "checks": {
                    "$ref": "#/definitions/handler.ReadinessChecks"
                },
                "env": {
                    "type": "string",
                    "example": "dev"
        ...
        "handler.RefreshCookieModeResponse": {
            "type": "object",
            "properties": {
                "refreshed": {
                    "type": "boolean",
        ...
        "handler.SendPasswordResetRequest": {
            "type": "object",
            "required": [
                "email"
            ],
        ...
        "model.LoginStatus": {
            ...
            "x-enum-varnames": [
                "LoginStatusSuccess",
                "LoginStatusFailedPassword",
                "LoginStatusFailedLocked",
                "LoginStatusFailedNotFound",
