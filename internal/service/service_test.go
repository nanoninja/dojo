...
// service_test.go holds shared fakes used across multiple service test files:
//   - fakeUserStore       — used by auth, audit, user tests
//   - fakeAuthStore       — used by auth and audit tests
//   - fakeRefreshTokenStore — used by auth and audit tests
//   - fakeMailer          — used by auth and audit tests
//   - fakeLoginAuditStore — used by auth, audit, and user tests
//   - fakeTxRunner / noopQuerier — used by course and bundle tests
